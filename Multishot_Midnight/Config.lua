local Lraw = LibStub("AceLocale-3.0"):GetLocale("Multishot", true)
local L = setmetatable({}, { __index = function(_, k) return (Lraw and rawget(Lraw, k)) or k end })
...
local GetFonts = function()
    ...
    local LSM3 = (LibStub and LibStub.GetLibrary) and LibStub:GetLibrary("LibSharedMedia-3.0", true)
    if LSM3 then
    ...
    args = {
        ...
        version = {
            ...
            name = string.format("%s\n    %s\n\n", "|cFFFFD700" .. L["Version"] .. "|r",
                (C_AddOns.GetAddOnMetadata("Multishot_Midnight","Version") or C_AddOns.GetAddOnMetadata("Multishot","Version") or "12.0.6"))
        },
        author = {
            order = 2,
            type = "description",
